 ...
 */
final class Version20260324183008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD date_of_birth DATE NOT NULL, ADD inscription_date DATE NOT NULL, ADD gender VARCHAR(20) NOT NULL, ADD is_active TINYINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP date_of_birth, DROP inscription_date, DROP gender, DROP is_active');
    }
}
