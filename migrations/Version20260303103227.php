 ...
 */
final class Version20260303103227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD stock INT NOT NULL, CHANGE images images VARCHAR(180) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP stock, CHANGE images images VARCHAR(180) NOT NULL');
